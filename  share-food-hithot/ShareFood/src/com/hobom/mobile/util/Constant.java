...
public class Constant {
	public static final String LASTLAT = "latitude";
	public static final String LASTLON = "longitude";

	public static String MYLOC = "我的位置";
	...
	public static final String INCREASE_ACCURACY_AWAKE ="notip";//SharedPreferences文件中精确度
}
